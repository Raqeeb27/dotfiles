...
echo "Welcome back, RAQEEB @ Termux.zsh" | lolcat

python ~/../start.py

figlet -f small '   MY ZSH' | lolcat
...
# python -m pywal --backend colorthief  -e -i /data/data/com.termux/files/home/car-red.png

# wal --backend colorthief -e -i /data/data/com.termux/files/home/car-red.png
